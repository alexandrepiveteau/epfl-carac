...
import test.examples.livevariables.livevariables as livevariables_test
...
class livevariables() extends livevariables_test {
  ...
  @Setup
  def setup(): Unit = {
    val factdir = Paths.get("..", "src", "test", "scala", "test", "examples", "livevariables", "facts")
    ...
    // Generate expected
    val expDir = Paths.get("..", "src", "test", "scala", "test", "examples", "livevariables", "expected")
