...
import test.examples.javapointsto.javapointsto as javapointsto_test
...
class javapointsto() extends javapointsto_test {
  ...
  @Setup
  def setup(): Unit = {
    val factdir = Paths.get("..", "src", "test", "scala", "test", "examples", "javapointsto", "facts")
    ...
    // Generate expected
    val expDir = Paths.get("..", "src", "test", "scala", "test", "examples", "javapointsto", "expected")
