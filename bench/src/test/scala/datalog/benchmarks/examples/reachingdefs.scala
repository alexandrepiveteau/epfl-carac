...
import test.examples.reachingdefs.reachingdefs as reachingdefs_test
...
class reachingdefs() extends reachingdefs_test {
  ...
  @Setup
  def setup(): Unit = {
    val factdir = Paths.get("..", "src", "test", "scala", "test", "examples", "reachingdefs", "facts")
    ...
    // Generate expected
    val expDir = Paths.get("..", "src", "test", "scala", "test", "examples", "reachingdefs", "expected")
